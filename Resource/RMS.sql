USE [RMS]
GO
/****** Object:  UserDefinedFunction [dbo].[GRFOSplit]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
...
END  
GO
/****** Object:  Table [dbo].[BUNames]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[BUNames](
	[BUNameId] [int] IDENTITY(1,1) NOT NULL,
	[BUName] [nvarchar](50) NOT NULL,
 CONSTRAINT [PK_BUNames] PRIMARY KEY CLUSTERED 
(
	[BUNameId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[BusinessType]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CustomerLocations]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[hadoopData]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Part_Dim]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RepairCategory]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RepairLocation]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RequestMaster]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[RequestMaster](
	...
	[partRequestId] [int] NULL,
	[downloadedTime] [datetime] NULL,
	[groupRequestId] [int] NULL,
...
GO
/****** Object:  Table [dbo].[RequestorSource]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[T1T2]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserDetails]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
SET IDENTITY_INSERT [dbo].[BUNames] ON 
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (1, N'CMP')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (2, N'CSG')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (3, N'DISPLAY')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (4, N'DSM')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (5, N'EPG')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (6, N'EPI')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (7, N'FEP')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (8, N'IMPLANT')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (9, N'MASK')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (10, N'MDP')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (11, N'PDC')
GO
INSERT [dbo].[BUNames] ([BUNameId], [BUName]) VALUES (12, N'PPC')
GO
SET IDENTITY_INSERT [dbo].[BUNames] OFF
GO
...
GO
INSERT [dbo].[BusinessType] ([BusinessTypeId], [RepairCategoryId], [BusinessType]) VALUES (3, NULL, N'adsddsdfsf')
GO
...
GO
INSERT [dbo].[BusinessType] ([BusinessTypeId], [RepairCategoryId], [BusinessType]) VALUES (6, NULL, N'asdadsd')
GO
...
GO
INSERT [dbo].[RequestMaster] ([RequestId], [RequestCategoryId], [BusinessTypeId], [RequestSourceId], [RequestorProjectGroup], [Requestor], [BasePartNumber], [PartDescription], [SolutionPartNumber], [NeedByDate], [BUNameId], [RepairLocationId], [TargetCustomer], [CustomerLocationId], [AnnualRepairForecast1], [AnnualRepairForecast2], [STDCostBasePart], [AnnualRepairForecast], [ExtendedSpendPotential], [pbg], [T1CustomerQty], [T2CustomerQty], [MG3], [Comments], [ScreeningStatus], [BusinessCaseStatus], [PilotReviewStatus], [PrdImplementation], [PrdDate], [ExectiveName], [GRFOComment], [CCNumber], [partRequestId], [downloadedTime], [groupRequestId]) VALUES (1, 1, 1, 1, N'Binary', N'Leo', N'0150-4576', N'sddsf', N'asd', NULL, 2, 2, N'asd', 1, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), CAST(20 AS Numeric(18, 0)), CAST(18 AS Numeric(18, 0)), CAST(360 AS Numeric(18, 0)), NULL, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), 1, N'test', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, 1)
GO
INSERT [dbo].[RequestMaster] ([RequestId], [RequestCategoryId], [BusinessTypeId], [RequestSourceId], [RequestorProjectGroup], [Requestor], [BasePartNumber], [PartDescription], [SolutionPartNumber], [NeedByDate], [BUNameId], [RepairLocationId], [TargetCustomer], [CustomerLocationId], [AnnualRepairForecast1], [AnnualRepairForecast2], [STDCostBasePart], [AnnualRepairForecast], [ExtendedSpendPotential], [pbg], [T1CustomerQty], [T2CustomerQty], [MG3], [Comments], [ScreeningStatus], [BusinessCaseStatus], [PilotReviewStatus], [PrdImplementation], [PrdDate], [ExectiveName], [GRFOComment], [CCNumber], [partRequestId], [downloadedTime], [groupRequestId]) VALUES (2, 1, 1, 1, N'Binary', N'Leo', N'0150-4576', N'sddsf', N'asd', NULL, 2, 2, N'asd', 1, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), CAST(20 AS Numeric(18, 0)), CAST(18 AS Numeric(18, 0)), CAST(360 AS Numeric(18, 0)), NULL, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), 1, N'test', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, 2)
GO
INSERT [dbo].[RequestMaster] ([RequestId], [RequestCategoryId], [BusinessTypeId], [RequestSourceId], [RequestorProjectGroup], [Requestor], [BasePartNumber], [PartDescription], [SolutionPartNumber], [NeedByDate], [BUNameId], [RepairLocationId], [TargetCustomer], [CustomerLocationId], [AnnualRepairForecast1], [AnnualRepairForecast2], [STDCostBasePart], [AnnualRepairForecast], [ExtendedSpendPotential], [pbg], [T1CustomerQty], [T2CustomerQty], [MG3], [Comments], [ScreeningStatus], [BusinessCaseStatus], [PilotReviewStatus], [PrdImplementation], [PrdDate], [ExectiveName], [GRFOComment], [CCNumber], [partRequestId], [downloadedTime], [groupRequestId]) VALUES (3, 1, 1, 1, N'Binary', N'Leo', N'0280-4589', N'sddsf', N'asd', NULL, 2, 2, N'asd', 1, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), CAST(33 AS Numeric(18, 0)), CAST(31 AS Numeric(18, 0)), CAST(1023 AS Numeric(18, 0)), NULL, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), 1, N'test', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, 2)
GO
INSERT [dbo].[RequestMaster] ([RequestId], [RequestCategoryId], [BusinessTypeId], [RequestSourceId], [RequestorProjectGroup], [Requestor], [BasePartNumber], [PartDescription], [SolutionPartNumber], [NeedByDate], [BUNameId], [RepairLocationId], [TargetCustomer], [CustomerLocationId], [AnnualRepairForecast1], [AnnualRepairForecast2], [STDCostBasePart], [AnnualRepairForecast], [ExtendedSpendPotential], [pbg], [T1CustomerQty], [T2CustomerQty], [MG3], [Comments], [ScreeningStatus], [BusinessCaseStatus], [PilotReviewStatus], [PrdImplementation], [PrdDate], [ExectiveName], [GRFOComment], [CCNumber], [partRequestId], [downloadedTime], [groupRequestId]) VALUES (4, 1, 1, 1, N'Binary', N'Leo', N'0320-4593', N'sddsf', N'asd', NULL, 2, 2, N'asd', 1, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), CAST(37 AS Numeric(18, 0)), CAST(35 AS Numeric(18, 0)), CAST(1295 AS Numeric(18, 0)), NULL, CAST(0 AS Numeric(18, 0)), CAST(0 AS Numeric(18, 0)), 1, N'test', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, 2)
GO
...
GO
INSERT [dbo].[RequestorSource] ([RequestorSourceId], [RequestorSource]) VALUES (5, N'Alt Refurb (Constrained/PRP)')
GO
INSERT [dbo].[RequestorSource] ([RequestorSourceId], [RequestorSource]) VALUES (6, N'BtoW Enablement')
GO
INSERT [dbo].[RequestorSource] ([RequestorSourceId], [RequestorSource]) VALUES (7, N'SMG RFQ (Pilot Lite)')
GO
INSERT [dbo].[RequestorSource] ([RequestorSourceId], [RequestorSource]) VALUES (8, N'Other')
GO
...
GO
INSERT [dbo].[UserDetails] ([userId], [username], [password], [roleId], [isDeleted]) VALUES (1, N'grfo', N'grfo', 0, 0)
GO
SET IDENTITY_INSERT [dbo].[UserDetails] OFF
GO
ALTER TABLE [dbo].[UserDetails] ADD  CONSTRAINT [DF_UserDetails_isDeleted]  DEFAULT ((0)) FOR [isDeleted]
GO
/****** Object:  StoredProcedure [dbo].[DashboardData_SelectAll]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[DashboardData_SelectAll]
...
BEGIN
	...
	SELECT BM.BUNameId, BM.BUName, COUNT(RM.BUNameId) COUNT
	FROM [dbo].[BUNames] BM
	LEFT JOIN [dbo].[RequestMaster] RM ON BM.BUNameId=RM.BUNameId
	GROUP BY BM.BUNameId, BM.BUName
END
GO
/****** Object:  StoredProcedure [dbo].[GetCustomerByIds]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[hadoop_Data_SelectAll]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[master_Data_Save]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Request_Report]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Request_Save]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	IF NOT EXISTS (SELECT [RequestId] FROM [dbo].[RequestMaster] WHERE [RequestId]=@RequestId)
		BEGIN
			...
			--	BEGIN
					...
					SET @RequestId = (SELECT IDENT_CURRENT('dbo.RequestMaster'))

					IF(@groupRequestId=0)
						BEGIN							
							UPDATE dbo.RequestMaster SET groupRequestId=@RequestId
							WHERE RequestId=@RequestId

							SELECT CONVERT(nvarchar,@RequestId)
						END
					ELSE
						BEGIN
							UPDATE dbo.RequestMaster SET groupRequestId=@groupRequestId
							WHERE RequestId=@RequestId

							SELECT CONVERT(nvarchar,@groupRequestId)
						END					
...
END
GO
/****** Object:  StoredProcedure [dbo].[Request_SelectAll]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Request_SelectById]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Request_SelectById]
	-- Add the parameters for the stored procedure here
	@groupRequestId int
AS
BEGIN
	...
	SELECT [RequestId]
		...
		,groupRequestId
	FROM [dbo].[RequestMaster]
	where groupRequestId=@groupRequestId
...
END
GO
/****** Object:  StoredProcedure [dbo].[Request_Status_Update]    Script Date: 07/06/2024 6:18:30 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
